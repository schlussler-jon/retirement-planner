    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="font-sans text-slate-400">
          Learn how to use my-moneyplan.com to create and analyze your financial future
        </p>
      </div>

      {/* Sections */}
      <Section title="Getting Started" defaultOpen={true}>
        <h3 className="text-white text-base font-semibold mb-2">Welcome to my-moneyplan.com!</h3>
      ...
      <Section title="People">
        ...
        <ul className="text-slate-300 text-sm list-disc list-inside mb-3 space-y-1">
          <li>Person 1: Jaime, born 1970</li>
          <li>Person 2: Lucinda, born 1968</li>
        </ul>
