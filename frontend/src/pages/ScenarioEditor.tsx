...
const STEPS: StepConfig[] = [
  {
    ...
    isComplete: s => s.people.some(p => p.name.trim() !== '' && p.birth_date !== ''),
    isRequired: true,
  ...
  },
  {
    ...
    isComplete: s => s.income_streams.some(s => s.monthly_amount_at_start > 0),
    isRequired: true,
    supportsAutoAdd: true,
  },
  {
    ...
    isComplete: s => s.accounts.some(a => a.name.trim() !== ''),
    isRequired: true,
    supportsAutoAdd: true,
  },
  {
