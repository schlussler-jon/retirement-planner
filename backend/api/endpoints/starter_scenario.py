...
def build_starter_scenario(scenario_id: str) -> dict:
    ...
    return {
        ...
        "budget_settings": {
            ...
            "survivor_flexible_reduction_percent": 0.20,
            "survivor_reduction_mode": "flex_only",
            "categories": [
                {
                    "category_name":  "Mortgage / Rent",
                    "category_type":  "fixed",
                    "monthly_amount": 2600.0,
                ...
                {
                    "category_name":  "Car & Gas",
                    "category_type":  "flexible",
                    "monthly_amount": 650.0,
                    "main_category":  "Transportation",
                    "include":        True,
                },
                {
                    "category_name":  "Health Insurance & Medical",
                    "category_type":  "fixed",
                    "monthly_amount": 480.0,
                    "main_category":  "Insurance & Healthcare",
                    "include":        True,
                },
                {
                    "category_name":  "Phone, Internet & Utilities",
                    "category_type":  "fixed",
                    "monthly_amount": 340.0,
                    "main_category":  "Utilities & Communications",
                    "include":        True,
                },
                {
                    "category_name":  "Entertainment & Subscriptions",
                    "category_type":  "flexible",
                    "monthly_amount": 420.0,
                ...
                },
                {
                    ...
                    "category_type":  "flexible",
                    "monthly_amount": 380.0,
                    "main_category":  "Entertainment & Lifestyle",
                    "include":        True,
                },
                {
                    "category_name":  "Gifts & Giving",
                    "category_type":  "flexible",
